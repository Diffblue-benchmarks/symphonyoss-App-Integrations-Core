...
public class CrlDiffblueTest {
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertLastUpdateNextUpdateExt_whenEmptyString()
    ...
    Crl.createCRL("", "Cert", 0, -1, new Extensions());
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertLastUpdateNextUpdateExt_whenEmptyString2()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", "", 0, -1, new Extensions());
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertLastUpdateNextUpdateExt_whenNull()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL(null, "Cert", 0, -1, new Extensions());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String Crl.createCRL(String, String, int, int, Extensions)"})
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertLastUpdateNextUpdateExt_whenNull2()
      throws Exception {
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", null, 0, -1, new Extensions());
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertLastUpdateNextUpdateExt_whenSecret()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", "Cert", 0, -1, new Extensions());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String Crl.createCRL(String, String, int, int, Extensions)"})
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertLastUpdateNextUpdateExt_whenSecret2()
      throws Exception {
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", "Cert", -1, -1, new Extensions());
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdate()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("", "Cert", "Sig Alg", 0, -1);
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdate2()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", "", "Sig Alg", 0, -1);
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdateExt()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", "Cert", "Sig Alg", 0, -1, new Extensions());
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdateExt2()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("", "Cert", "Sig Alg", 0, -1, new Extensions());
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdateExt3()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", "", "Sig Alg", 0, -1, new Extensions());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String Crl.createCRL(String, String, String, int, int, Extensions)"})
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdateExt4()
      throws Exception {
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", "Cert", "Sig Alg", -1, -1, new Extensions());
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdateExt_whenNull()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL(null, "Cert", "Sig Alg", 0, -1, new Extensions());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String Crl.createCRL(String, String, String, int, int, Extensions)"})
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdateExt_whenNull2()
      throws Exception {
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", null, "Sig Alg", 0, -1, new Extensions());
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdate_whenNull()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", null, "Sig Alg", 0, 0);
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdate_whenNull2()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL(null, "Cert", "Sig Alg", 0, 0);
  }
  ...
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdate_whenSecret()
    ...
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", "Cert", "Sig Alg", 0, -1);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String Crl.createCRL(String, String, String, int, int)"})
  public void testCreateCRLWithPEMEncodedRSAKeyPairCertSigAlgLastUpdateNextUpdate_whenSecret2()
      throws Exception {
    // Arrange, Act and Assert
    thrown.expect(Exception.class);
    Crl.createCRL("secret", "Cert", "Sig Alg", -1, 0);
  }
}
