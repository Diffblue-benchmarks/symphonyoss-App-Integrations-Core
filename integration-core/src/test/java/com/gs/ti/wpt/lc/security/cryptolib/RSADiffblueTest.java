...
public class RSADiffblueTest {
  ...
  public void testDecrypt_whenA()
    ...
    RSA.Decrypt(null, new byte[] {'A', 'X', 'A', 'X', 'A', 'X', 'A', 'X'}, 0);
  }
  ...
  public void testEncrypt_whenA()
      throws SymphonyEncryptionException, SymphonyInputException, SymphonyPEMFormatException,
          UnsupportedEncodingException {
    // Arrange, Act and Assert
    thrown.expect(SymphonyInputException.class);
    RSA.Encrypt(null, new byte[] {'A', 'X', 'A', 'X', 'A', 'X', 'A', 'X'}, 0);
  }
  ...
  public void testSign_whenA()
      throws SymphonyEncryptionException, SymphonyInputException, SymphonyPEMFormatException,
          UnsupportedEncodingException {
    // Arrange, Act and Assert
    thrown.expect(SymphonyInputException.class);
    RSA.Sign(null, new byte[] {'A', 'X', 'A', 'X', 'A', 'X', 'A', 'X'}, 0);
  }
  ...
  public void testVerify_whenArrayOfByteWithAAndX()
      throws SymphonyEncryptionException, SymphonyInputException, SymphonyPEMFormatException,
          UnsupportedEncodingException {
    // Arrange, Act and Assert
    thrown.expect(SymphonyInputException.class);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean RSA.Verify(String, byte[], byte[], int)"})
  public void testVerify_whenBeginPublicKey2()
      throws SymphonyEncryptionException, SymphonyInputException, SymphonyPEMFormatException,
          UnsupportedEncodingException {
    // Arrange, Act and Assert
    thrown.expect(SymphonyInputException.class);
    RSA.Verify(
        "-----BEGIN PUBLIC KEY-----", null, new byte[] {'A', 'X', 'A', 'X', 'A', 'X', 'A', 'X'}, 0);
  }
}
