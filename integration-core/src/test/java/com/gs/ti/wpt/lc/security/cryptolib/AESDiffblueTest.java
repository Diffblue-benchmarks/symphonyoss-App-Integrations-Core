...
public class AESDiffblueTest {
  ...
  public void testDecryptCBC_whenA() throws SymphonyEncryptionException, SymphonyInputException {
  ...
  @Test
  @MethodsUnderTest({"byte[] AES.DecryptCBC(byte[], byte[], byte[])"})
  public void testDecryptCBC_whenA2() throws SymphonyEncryptionException, SymphonyInputException {
    // Arrange, Act and Assert
    thrown.expect(SymphonyInputException.class);
  ...
  @Test
  @MethodsUnderTest({"byte[] AES.DecryptCBC(byte[], byte[], byte[])"})
  public void testDecryptCBC_whenAxaxaxaxBytesIsUtf8()
  ...
  @Test
  @MethodsUnderTest({"byte[] AES.DecryptCBC(byte[], byte[], byte[])"})
  public void testDecryptCBC_whenEmptyArrayOfByte()
      throws SymphonyEncryptionException, SymphonyInputException, UnsupportedEncodingException {
    // Arrange
    byte[] Key = "AXAXAXAX".getBytes("UTF-8");
  ...
  @Test
  @MethodsUnderTest({"byte[] AES.DecryptCBC(byte[], byte[], byte[])"})
  public void testDecryptCBC_whenNull() throws SymphonyEncryptionException, SymphonyInputException {
    // Arrange, Act and Assert
    thrown.expect(SymphonyInputException.class);
   ...
   * </ul>
   * <p>
   * Method under test: {@link AES#DecryptGCM(byte[], byte[], byte[], byte[], byte[])}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link AES#EncryptGCM(byte[], byte[], byte[], byte[], byte[])}
   */
  @Test
