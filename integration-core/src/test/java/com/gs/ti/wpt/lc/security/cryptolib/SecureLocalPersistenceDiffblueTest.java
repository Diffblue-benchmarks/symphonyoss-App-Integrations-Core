...
public class SecureLocalPersistenceDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link SecureLocalPersistence#SecureLocalPersistence(byte[], String)}
   */
  @Test
  @MethodsUnderTest({"void SecureLocalPersistence.<init>(byte[], String)"})
  public void testNewSecureLocalPersistence_whenA() throws SymphonyInputException, SymphonyNativeException {
  ...
  @Test
  @MethodsUnderTest({"void SecureLocalPersistence.<init>(byte[], String)"})
  public void testNewSecureLocalPersistence_whenAxaxaxaxBytesIsUtf8()
  ...
  @Test
  @MethodsUnderTest({"void SecureLocalPersistence.<init>(byte[], String)"})
  public void testNewSecureLocalPersistence_whenNull() throws SymphonyInputException, SymphonyNativeException {
    // Arrange, Act and Assert
    thrown.expect(SymphonyInputException.class);
