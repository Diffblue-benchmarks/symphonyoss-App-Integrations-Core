...
public class KeyIdentifierDiffblueTest {
   ...
   *   <li>Then return IsPublic is {@code null}.</li>
   * </ul>
   * <p>
   * Methods under test:
   * <ul>
   ...
   */
  @Test
  @MethodsUnderTest({"void KeyIdentifier.<init>(byte[], Long, Long)",
      "void KeyIdentifier.<init>(byte[], Long, Long, Boolean)", "Boolean KeyIdentifier.getIsPublic()",
      "Long KeyIdentifier.getRotationId()", "byte[] KeyIdentifier.getStreamId()", "Long KeyIdentifier.getUserId()"})
  ...
  @MethodsUnderTest({"void KeyIdentifier.<init>(byte[], Long, Long)",
      "void KeyIdentifier.<init>(byte[], Long, Long, Boolean)", "Boolean KeyIdentifier.getIsPublic()",
      "Long KeyIdentifier.getRotationId()", "byte[] KeyIdentifier.getStreamId()", "Long KeyIdentifier.getUserId()"})
  public void testGettersAndSetters_whenTrue_thenReturnIsPublic() throws UnsupportedEncodingException {
    // Arrange
    byte[] streamId = "AXAXAXAX".getBytes("UTF-8");
   ...
   * <ul>
   *   <li>Given {@code A}.</li>
   *   <li>Then return {@code /1hBWEFYQVg= (isPublic=null) FOR userId=1 @ rotationId=1}.</li>
   * </ul>
   * <p>
   * Method under test: {@link KeyIdentifier#toString()}
   */
   ...
   * Test {@link KeyIdentifier#toString()}.
   * <ul>
   *   <li>Then return {@code (isPublic=null) FOR userId=1 @ rotationId=1}.</li>
   * </ul>
   * <p>
   * Method under test: {@link KeyIdentifier#toString()}
   */
   ...
   * Test {@link KeyIdentifier#toString()}.
   * <ul>
   *   <li>Then return {@code null (isPublic=null) FOR userId=1 @ rotationId=1}.</li>
   * </ul>
   * <p>
   * Method under test: {@link KeyIdentifier#toString()}
   */
   ...
   * Test {@link KeyIdentifier#toString()}.
   * <ul>
   *   <li>Then return {@code QVhBWEFYQVg= (isPublic=null) FOR userId=1 @ rotationId=1}.</li>
   * </ul>
   * <p>
   * Method under test: {@link KeyIdentifier#toString()}
   */
   ...
   * Test {@link KeyIdentifier#toString()}.
   * <ul>
   *   <li>Then return {@code QVhBWEFYQVg= (isPublic=public) FOR userId=1 @ rotationId=1}.</li>
   * </ul>
   * <p>
   * Method under test: {@link KeyIdentifier#toString()}
   */
   ...
   * Test {@link KeyIdentifier#toString()}.
   * <ul>
   *   <li>Then return {@code QVhBWEFYQVhBWEFYQVhBWA== (isPublic=null) FOR userId=1 @ rotationId=1}.</li>
   * </ul>
   * <p>
   * Method under test: {@link KeyIdentifier#toString()}
   */
