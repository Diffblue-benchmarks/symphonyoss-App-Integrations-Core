...
public class ClientCryptoHandlerDiffblueTest {
  ...
  /**
   * Test {@link ClientCryptoHandler#encryptMsg(byte[], KeyIdentifier, byte[], byte)} with {@code key}, {@code keyId}, {@code plaintext}, {@code ciphertextTransportEncryptionMode}.
   * <p>
   * Method under test: {@link ClientCryptoHandler#encryptMsg(byte[], KeyIdentifier, byte[], byte)}
   */
  @Test
  ...
  public void testEncryptMsgWithKeyKeyIdPlaintextCiphertextTransportEncryptionMode()
      throws CiphertextTransportVersionException, SymphonyEncryptionException, SymphonyInputException,
