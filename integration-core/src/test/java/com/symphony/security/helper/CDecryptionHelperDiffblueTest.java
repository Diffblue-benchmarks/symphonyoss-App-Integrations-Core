...
public class CDecryptionHelperDiffblueTest {
  ...
  /**
   * Test {@link CDecryptionHelper#encrypt(byte[], int, int, long)} with {@code byte[]}, {@code int}, {@code int}, {@code long}.
   * <p>
  ...
  public void testEncryptWithByteIntIntLong() throws SymphonyEncryptionException, UnsupportedEncodingException {
    // Arrange
  ...
  /**
   * Test {@link CDecryptionHelper#encrypt(byte[], int, int, long, byte)} with {@code byte[]}, {@code int}, {@code int}, {@code long}, {@code byte}.
   * <ul>
   *   <li>Then throw {@link SymphonyEncryptionException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CDecryptionHelper#encrypt(byte[], int, int, long, byte)}
   */
  @Test
  ...
  /**
   * Test {@link CDecryptionHelper#encrypt(String, int, int, long)} with {@code String}, {@code int}, {@code int}, {@code long}.
   * <p>
