...
public class ClientCertDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"long ClientCert.getCertId()", "byte[] ClientCert.getClientCert()",
      "String ClientCert.getClientCertPEM()", "Long ClientCert.getUserId()", "int ClientCert.getVersion()",
      "byte[] ClientCert.getWrappedRSAKey()", "String ClientCert.toString()"})
   ...
   *   <li>Then return ClientCertPEM is {@code AXAXAXAX}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ClientCert#ClientCert(Long, long, int, byte[], byte[])}
   */
  @Test
  ...
  public void testNewClientCert_whenAxaxaxaxBytesIsUtf8_thenReturnClientCertPEMIsAxaxaxax()
    ...
    // Act
    ClientCert actualClientCert = new ClientCert(1L, 1L, 1, clientCert, "AXAXAXAX".getBytes("UTF-8"));
   ...
   *   <li>Then throw {@link ClientCertException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ClientCert#ClientCert(Long, long, int, byte[], byte[])}
   */
