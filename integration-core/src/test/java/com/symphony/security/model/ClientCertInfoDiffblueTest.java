...
public class ClientCertInfoDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"CertStatus ClientCertInfo.getCertStatus()", "ClientCert ClientCertInfo.getClientCert()",
      "long ClientCertInfo.getNotAfter()", "long ClientCertInfo.getNotBefore()"})
   ...
   * <p>
   * Method under test: {@link ClientCertInfo#ClientCertInfo(ClientCert, CertStatus, long, long)}
   */
  @Test
