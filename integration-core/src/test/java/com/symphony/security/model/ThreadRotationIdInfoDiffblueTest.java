...
public class ThreadRotationIdInfoDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"void ThreadRotationIdInfo.<init>(String, int, int, int)",
      "int ThreadRotationIdInfo.getAcceptedRotationId()", "int ThreadRotationIdInfo.getAcceptedRotationRange()",
      "int ThreadRotationIdInfo.getRetiredRotationId()", "String ThreadRotationIdInfo.getStreamId()"})
