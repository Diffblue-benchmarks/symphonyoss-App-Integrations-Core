...
public class SecurePersisterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link SecurePersister#SecurePersister(IPersister, long)} with persister is {@link
   *       SecurePersister#SecurePersister(IPersister, long)} and randSeed is one.
   * </ul>
   *
  ...
  public void testRetrieve_givenSecurePersisterWithPersisterIsSecurePersisterAndRandSeedIsOne()
    ...
    // Arrange
    SecurePersister securePersister =
        new SecurePersister(new SecurePersister(new InMemoryPersister(), 1L), 1L);
