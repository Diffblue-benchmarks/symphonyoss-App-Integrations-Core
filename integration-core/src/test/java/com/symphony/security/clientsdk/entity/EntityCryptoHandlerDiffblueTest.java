...
public class EntityCryptoHandlerDiffblueTest {
  ...
  public void testEncrypt_whenPlainText_thenThrowSymphonyEncryptionException() throws SymphonyEncryptionException,
      SymphonyInputException, UnsupportedEncodingException, NoSuchAlgorithmException {
  ...
  @Test
  @MethodsUnderTest({"String EntityCryptoHandler.encrypt(String, byte[])"})
  public void testEncrypt_whenQuestionMark_thenThrowSymphonyEncryptionException() throws SymphonyEncryptionException,
      SymphonyInputException, UnsupportedEncodingException, NoSuchAlgorithmException {
    // Arrange, Act and Assert
    thrown.expect(SymphonyEncryptionException.class);
