...
public class ClientTokenizer_v2DiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link ClientTokenizer_v2#getHashedTokens(Collection, byte[], long)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testGetHashedTokens_givenFoo_whenEmptyArrayOfByte_thenReturnContainsNull()
    ...
    // Act
    Set<String> actualHashedTokens =
        clientTokenizer_v2.getHashedTokens(plainTokens, new byte[] {}, 1L);
  ...
  public void testGetHashedTokens_givenHmacSHA256_thenReturnSizeIsTwo()
    ...
    // Act
    Set<String> actualHashedTokens =
        clientTokenizer_v2.getHashedTokens(plainTokens, "AXAXAXAX".getBytes("UTF-8"), 1L);
   ...
   *
   * <ul>
   *   <li>Then return contains {@code 1nrb9IUj53PZTBPzgRh+eQJijQnrM8r7thjawqky2e8=}.
   * </ul>
   *
   * <p>Method under test: {@link ClientTokenizer_v2#getHashedTokens(Collection, byte[], long)}
   */
  ...
  public void testGetHashedTokens_whenArrayList_thenReturnEmpty()
    ...
    assertTrue(
        clientTokenizer_v2
            .getHashedTokens(plainTokens, "AXAXAXAX".getBytes("UTF-8"), 1L)
            .isEmpty());
  }
   ...
   * <ul>
   *   <li>When {@code Input}.
   *   <li>Then return contains {@code input}.
   * </ul>
   *
   * <p>Method under test: {@link ClientTokenizer_v2#getPlainTokens(String)}
   */
  @Test
  @ManagedByDiffblue
   ...
   * <ul>
   *   <li>When {@code \s+}.
   *   <li>Then return contains {@code s}.
   * </ul>
   *
   * <p>Method under test: {@link ClientTokenizer_v2#getPlainTokens(String)}
   */
   ...
   *
   * <p>Method under test: {@link ClientTokenizer_v2#getSalt(byte[])}
   */
  @Test
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Then return {@code WJ7PfnhLIQxcpO5XWIgSLJMpyMHKL54NmVkrkQ6E/UQ=}.
   * </ul>
   *
   * <p>Method under test: {@link ClientTokenizer_v2#hashHMAC256B64(String, byte[])}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testHashHMAC256B64_thenReturnWJ7PfnhLIQxcpO5XWIgSLJMpyMHKL54NmVkrkQ6EUq()
    ...
    // Arrange, Act and Assert
    assertEquals(
        "WJ7PfnhLIQxcpO5XWIgSLJMpyMHKL54NmVkrkQ6E/UQ=",
   ...
   *
   * <ul>
   *   <li>Given {@code SHA-256}.
   *   <li>When {@link ArrayList#ArrayList()} add {@code SHA-256}.
   *   <li>Then return size is three.
   * </ul>
   *
   * <p>Method under test: {@link ClientTokenizer_v2#tokenize(String, Collection, byte[], byte[],
   * long)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testTokenize_givenSha256_whenArrayListAddSha256_thenReturnSizeIsThree()
    ...
    assertEquals(
        3,
        clientTokenizer_v2
            .tokenize("Text", hashtags, privateContentKey, "AXAXAXAX".getBytes("UTF-8"), 1L)
            .size());
  }
   ...
   *
   * <ul>
   *   <li>Then return first is {@code /pOW9U5Tmo9VVm/d1jtjbmAM9Zl5Kh8wKNAH6SrdaF8=}.
   * </ul>
   *
   * <p>Method under test: {@link ClientTokenizer_v2#tokenize(String, Collection, byte[], byte[],
   * long)}
  ...
  public void testTokenize_thenReturnFirstIsPOW9U5Tmo9VVmD1jtjbmAM9Zl5Kh8wKNAH6SrdaF8()
    ...
    List<String> actualTokenizeResult =
        clientTokenizer_v2.tokenize(
            "Text", hashtags, privateContentKey, "AXAXAXAX".getBytes("UTF-8"), 1L);
   ...
   * <ul>
   *   <li>When {@code \s+}.
   *   <li>Then return first is {@code gHHZpvVa1mz6z8rSH5VQbJGuwqmUfsoD25aGzd3ypwI=}.
   * </ul>
   *
   * <p>Method under test: {@link ClientTokenizer_v2#tokenize(String, Collection, byte[], byte[],
   * long)}
  ...
  public void testTokenize_whenS_thenReturnFirstIsGHHZpvVa1mz6z8rSH5VQbJGuwqmUfsoD25aGzd3ypwI()
    ...
    List<String> actualTokenizeResult =
        clientTokenizer_v2.tokenize(
            "\\s+", hashtags, privateContentKey, "AXAXAXAX".getBytes("UTF-8"), 1L);
