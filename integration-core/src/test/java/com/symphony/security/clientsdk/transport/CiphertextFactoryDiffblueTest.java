...
public class CiphertextFactoryDiffblueTest {
   ...
   *
   * <p>Method under test: {@link CiphertextFactory#getTransport(byte[])}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  public void testGetTransportWithTransportableBytes()
      throws CiphertextTransportIsEmptyException, CiphertextTransportVersionException,
  ...
  public void testGetTransportWithTransportableBytes2()
      throws CiphertextTransportIsEmptyException, CiphertextTransportVersionException,
   ...
   *
   * <ul>
   *   <li>When a string Bytes is {@code UTF-8}.
   * </ul>
   *
   * <p>Method under test: {@link CiphertextFactory#getTransport(byte[])}
   */
