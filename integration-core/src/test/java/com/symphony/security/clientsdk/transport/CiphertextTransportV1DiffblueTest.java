...
public class CiphertextTransportV1DiffblueTest {
   ...
   * <ul>
   *   <li>Then return array of {@code byte} with {@link CiphertextTransportEncryptionMode#AES_CBC} and {@link CiphertextTransportEncryptionMode#AES_GCM}.</li>
   * </ul>
   * <p>
  ...
  public void testGetRawData_thenReturnArrayOfByteWithAes_cbcAndAes_gcm() throws UnsupportedEncodingException {
    // Arrange
    byte[] cipherText = "AXAXAXAX".getBytes("UTF-8");
    byte[] aad = "AXAXAXAX".getBytes("UTF-8");
    byte[] iv = "AXAXAXAX".getBytes("UTF-8");
  ...
  public void testGetRotationId_thenThrowIllegalStateException() throws UnsupportedEncodingException {
    // Arrange
    byte[] cipherText = "AXAXAXAX".getBytes("UTF-8");
    byte[] aad = "AXAXAXAX".getBytes("UTF-8");
    byte[] iv = "AXAXAXAX".getBytes("UTF-8");
   ...
   */
  @Test
  @MethodsUnderTest({"void CiphertextTransportV1.<init>(byte[], byte[], byte[], byte[])",
      "byte[] CiphertextTransportV1.getAuthData()", "byte[] CiphertextTransportV1.getCiphertext()",
      "byte CiphertextTransportV1.getEncryptionMode()", "byte[] CiphertextTransportV1.getIV()",
      "byte[] CiphertextTransportV1.getKeyId()", "byte CiphertextTransportV1.getOptions()",
      "byte[] CiphertextTransportV1.getSalt()", "byte[] CiphertextTransportV1.getTag()",
      "byte CiphertextTransportV1.getVersion()", "boolean CiphertextTransportV1.hasKeyId()",
   ...
   * <ul>
   *   <li>When array of {@code byte} with {@link CiphertextTransportEncryptionMode#AES_CBC} and {@link CiphertextTransportEncryptionMode#AES_CBC}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CiphertextTransportV1#CiphertextTransportV1(byte[])}
   */
  @Test
  @MethodsUnderTest({"void CiphertextTransportV1.<init>(byte[])"})
  public void testNewCiphertextTransportV1_whenArrayOfByteWithAes_cbcAndAes_cbc() throws InvalidDataException {
   ...
   * Test {@link CiphertextTransportV1#CiphertextTransportV1(byte[])}.
   * <ul>
   *   <li>When array of {@code byte} with {@link CiphertextTransportEncryptionMode#AES_CBC} and {@link CiphertextTransportEncryptionMode#AES_GCM}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CiphertextTransportV1#CiphertextTransportV1(byte[])}
   */
  @Test
  @MethodsUnderTest({"void CiphertextTransportV1.<init>(byte[])"})
  public void testNewCiphertextTransportV1_whenArrayOfByteWithAes_cbcAndAes_gcm() throws InvalidDataException {
    // Arrange, Act and Assert
    thrown.expect(InvalidDataException.class);
    new CiphertextTransportV1(new byte[]{CiphertextTransportEncryptionMode.AES_CBC,
   ...
   * Test {@link CiphertextTransportV1#CiphertextTransportV1(byte[])}.
   * <ul>
   *   <li>When array of {@code byte} with {@link CiphertextTransportEncryptionMode#AES_CBC} and {@code X}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CiphertextTransportV1#CiphertextTransportV1(byte[])}
   */
  @Test
  @MethodsUnderTest({"void CiphertextTransportV1.<init>(byte[])"})
  public void testNewCiphertextTransportV1_whenArrayOfByteWithAes_cbcAndX() throws InvalidDataException {
    // Arrange, Act and Assert
    thrown.expect(InvalidDataException.class);
