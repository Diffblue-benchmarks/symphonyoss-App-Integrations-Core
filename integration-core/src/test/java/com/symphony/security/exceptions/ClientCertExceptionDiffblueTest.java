...
public class ClientCertExceptionDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link ClientCertException#ClientCertException(String)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ClientCertException.<init>(String)",
    "void ClientCertException.<init>(String, Throwable)"
  })
   ...
   * </ul>
   *
   * <p>Method under test: {@link ClientCertException#ClientCertException(String, Throwable)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
