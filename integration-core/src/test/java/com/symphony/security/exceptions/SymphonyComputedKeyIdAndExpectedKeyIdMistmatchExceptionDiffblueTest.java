...
public class SymphonyComputedKeyIdAndExpectedKeyIdMistmatchExceptionDiffblueTest {
  /**
   * Test {@link SymphonyComputedKeyIdAndExpectedKeyIdMistmatchException#SymphonyComputedKeyIdAndExpectedKeyIdMistmatchException(byte[], byte[])}.
   * <p>
   * Method under test: {@link SymphonyComputedKeyIdAndExpectedKeyIdMistmatchException#SymphonyComputedKeyIdAndExpectedKeyIdMistmatchException(byte[], byte[])}
   */
  @Test
  @MethodsUnderTest({"void SymphonyComputedKeyIdAndExpectedKeyIdMistmatchException.<init>(byte[], byte[])"})
