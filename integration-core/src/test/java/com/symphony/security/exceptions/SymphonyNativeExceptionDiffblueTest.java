...
public class SymphonyNativeExceptionDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link SymphonyNativeException#SymphonyNativeException(String, Throwable)}
   */
  @Test
  @MethodsUnderTest({"void SymphonyNativeException.<init>()", "void SymphonyNativeException.<init>(String)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link SymphonyNativeException#SymphonyNativeException(Throwable)}
   */
  @Test
  @MethodsUnderTest({"void SymphonyNativeException.<init>()", "void SymphonyNativeException.<init>(String)",
      "void SymphonyNativeException.<init>(String, Throwable)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link SymphonyNativeException#SymphonyNativeException(String)}
   */
  @Test
  @MethodsUnderTest({"void SymphonyNativeException.<init>()", "void SymphonyNativeException.<init>(String)",
      "void SymphonyNativeException.<init>(String, Throwable)",
  ...
  /**
   * Test {@link SymphonyNativeException#SymphonyNativeException(String, Throwable, boolean, boolean)}.
   * <ul>
   *   <li>When {@code true}.</li>
   *   <li>Then return Message is {@code An error occurred}.</li>
   * </ul>
   * <p>
   * Method under test: {@link SymphonyNativeException#SymphonyNativeException(String, Throwable, boolean, boolean)}
   */
  @Test
  @MethodsUnderTest({"void SymphonyNativeException.<init>()", "void SymphonyNativeException.<init>(String)",
      "void SymphonyNativeException.<init>(String, Throwable)",
