...
public class InvalidDataExceptionDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link InvalidDataException#InvalidDataException(String, Throwable)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void InvalidDataException.<init>()",
    "void InvalidDataException.<init>(String)",
  ...
  public void testNewInvalidDataException_thenReturnMessageIsAnErrorOccurred() {
    ...
    // Act
    InvalidDataException actualInvalidDataException =
        new InvalidDataException("An error occurred", cause);
   ...
   * </ul>
   *
   * <p>Method under test: {@link InvalidDataException#InvalidDataException()}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
   ...
   * </ul>
   *
   * <p>Method under test: {@link InvalidDataException#InvalidDataException(String)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
   ...
   * </ul>
   *
   * <p>Method under test: {@link InvalidDataException#InvalidDataException(Throwable)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  public void testNewInvalidDataException_whenTrue_thenReturnMessageIsAnErrorOccurred() {
    ...
    // Act
    InvalidDataException actualInvalidDataException =
        new InvalidDataException("An error occurred", cause, true, true);
