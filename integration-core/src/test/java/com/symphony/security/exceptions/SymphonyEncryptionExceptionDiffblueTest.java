...
public class SymphonyEncryptionExceptionDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link SymphonyEncryptionException#SymphonyEncryptionException(String, Throwable)}
   */
  @Test
  @MethodsUnderTest({"void SymphonyEncryptionException.<init>()", "void SymphonyEncryptionException.<init>(String)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link SymphonyEncryptionException#SymphonyEncryptionException(Throwable)}
   */
  @Test
  @MethodsUnderTest({"void SymphonyEncryptionException.<init>()", "void SymphonyEncryptionException.<init>(String)",
      "void SymphonyEncryptionException.<init>(String, Throwable)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link SymphonyEncryptionException#SymphonyEncryptionException()}
   */
  @Test
  @MethodsUnderTest({"void SymphonyEncryptionException.<init>()", "void SymphonyEncryptionException.<init>(String)",
      "void SymphonyEncryptionException.<init>(String, Throwable)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link SymphonyEncryptionException#SymphonyEncryptionException(String)}
   */
  @Test
  @MethodsUnderTest({"void SymphonyEncryptionException.<init>()", "void SymphonyEncryptionException.<init>(String)",
      "void SymphonyEncryptionException.<init>(String, Throwable)",
  ...
  /**
   * Test {@link SymphonyEncryptionException#SymphonyEncryptionException(String, Throwable, boolean, boolean)}.
   * <ul>
   *   <li>When {@code true}.</li>
   *   <li>Then return Message is {@code An error occurred}.</li>
   * </ul>
   * <p>
   * Method under test: {@link SymphonyEncryptionException#SymphonyEncryptionException(String, Throwable, boolean, boolean)}
   */
  @Test
  @MethodsUnderTest({"void SymphonyEncryptionException.<init>()", "void SymphonyEncryptionException.<init>(String)",
      "void SymphonyEncryptionException.<init>(String, Throwable)",
