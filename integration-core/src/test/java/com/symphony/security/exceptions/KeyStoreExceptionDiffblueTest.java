...
public class KeyStoreExceptionDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link KeyStoreException#KeyStoreException(String)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void KeyStoreException.<init>(String)",
    "void KeyStoreException.<init>(String, Throwable)",
   ...
   * </ul>
   *
   * <p>Method under test: {@link KeyStoreException#KeyStoreException(String, Throwable)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
   ...
   * </ul>
   *
   * <p>Method under test: {@link KeyStoreException#KeyStoreException(Throwable)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
