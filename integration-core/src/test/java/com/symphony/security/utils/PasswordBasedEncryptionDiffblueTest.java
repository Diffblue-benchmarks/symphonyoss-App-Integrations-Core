...
public class PasswordBasedEncryptionDiffblueTest {
   ...
   * <ul>
   *   <li>When {@link PasswordBasedEncryption#AES_CBC_PKCS5_PADDING}.</li>
   ...
   * Test {@link PasswordBasedEncryption#decrypt(char[], String)}.
   * <ul>
   *   <li>When {@code Encrypted Text}.</li>
   *   <li>Then throw {@link SymphonyEncryptionException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PasswordBasedEncryption#decrypt(char[], String)}
  ...
  @Test
  @MethodsUnderTest({"String PasswordBasedEncryption.decrypt(char[], String)"})
  public void testDecrypt_whenEncryptedText_thenThrowSymphonyEncryptionException() throws SymphonyEncryptionException {
    // Arrange, Act and Assert
    thrown.expect(SymphonyEncryptionException.class);
  ...
  @Test
  @MethodsUnderTest({"String PasswordBasedEncryption.encrypt(char[], String)"})
  public void testEncrypt_whenNull_thenThrowIllegalArgumentException() throws SymphonyEncryptionException {
    // Arrange, Act and Assert
    thrown.expect(IllegalArgumentException.class);
