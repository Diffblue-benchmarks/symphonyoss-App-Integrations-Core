...
public class PropertyDecrypterDiffblueTest {
  ...
  /**
   * Test {@link PropertyDecrypter#encryptPropertyViaPrompt(UserInput)} with {@code passwordAndPropertyUserInput}.
   * <p>
   * Method under test: {@link PropertyDecrypter#encryptPropertyViaPrompt(UserInput)}
   */
  @Test
  @MethodsUnderTest({"String PropertyDecrypter.encryptPropertyViaPrompt(UserInput)"})
  public void testEncryptPropertyViaPromptWithPasswordAndPropertyUserInput() throws SymphonyEncryptionException {
    // Arrange
  ...
  @Test
  @MethodsUnderTest({"String PropertyDecrypter.encryptPropertyViaPrompt(UserInput)"})
  public void testEncryptPropertyViaPromptWithPasswordAndPropertyUserInput2() throws SymphonyEncryptionException {
    // Arrange
    UserInput passwordAndPropertyUserInput = mock(UserInput.class);
  ...
  /**
   * Test {@link PropertyDecrypter#encryptPropertyViaPrompt(UserInput, char[])} with {@code propertyUserInput}, {@code pwd}.
   * <p>
   * Method under test: {@link PropertyDecrypter#encryptPropertyViaPrompt(UserInput, char[])}
   */
  @Test
  @MethodsUnderTest({"String PropertyDecrypter.encryptPropertyViaPrompt(UserInput, char[])"})
  public void testEncryptPropertyViaPromptWithPropertyUserInputPwd() throws SymphonyEncryptionException {
    // Arrange
   ...
   * Test {@link PropertyDecrypter#encryptPropertyViaPrompt(UserInput, char[])} with {@code propertyUserInput}, {@code pwd}.
   * <ul>
   *   <li>Then calls {@link UserInput#getSecret(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PropertyDecrypter#encryptPropertyViaPrompt(UserInput, char[])}
   */
   ...
   * <p>
   * Method under test: {@link PropertyDecrypter#encryptPropertyWithPasswordFromEnvAndPropertyFromPrompt()}
   */
  @Test
  @MethodsUnderTest({"String PropertyDecrypter.encryptPropertyWithPasswordFromEnvAndPropertyFromPrompt()"})
  ...
  /**
   * Test {@link PropertyDecrypter#encryptPropertyWithPasswordFromEnvAndPropertyFromPrompt(UserInput)} with {@code UserInput}.
   * <p>
   * Method under test: {@link PropertyDecrypter#encryptPropertyWithPasswordFromEnvAndPropertyFromPrompt(UserInput)}
   */
  @Test
  @MethodsUnderTest({"String PropertyDecrypter.encryptPropertyWithPasswordFromEnvAndPropertyFromPrompt(UserInput)"})
  public void testEncryptPropertyWithPasswordFromEnvAndPropertyFromPromptWithUserInput()
      throws SymphonyEncryptionException {
    // Arrange, Act and Assert
    thrown.expect(IllegalArgumentException.class);
    PropertyDecrypter.encryptPropertyWithPasswordFromEnvAndPropertyFromPrompt(mock(UserInput.class));
  }
   ...
   * <ul>
   *   <li>Given {@code 42}.</li>
   *   <li>When {@link Properties#Properties()} {@code 42} is {@code 42}.</li>
   *   <li>Then return Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link PropertyDecrypter#getDecryptedProperties(Properties)}
   */
  @Test
   ...
   * <ul>
   *   <li>Given one.</li>
   *   <li>When {@link Properties#Properties()} {@code 42} is one.</li>
   *   <li>Then return Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link PropertyDecrypter#getDecryptedProperties(Properties)}
   ...
   * Test {@link PropertyDecrypter#getDecryptedProperties(Properties)}.
   * <ul>
   *   <li>Given {@link PropertyDecrypter#PREFIX}.</li>
   *   <li>When {@link Properties#Properties()} {@code 42} is {@link PropertyDecrypter#PREFIX}.</li>
   *   <li>Then return Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link PropertyDecrypter#getDecryptedProperties(Properties)}
  ...
  @Test
  @MethodsUnderTest({"Properties PropertyDecrypter.getDecryptedProperties(Properties)"})
  public void testGetDecryptedProperties_whenProperties_thenReturnProperties() throws SymphonyEncryptionException {
    // Arrange
    Properties source = new Properties();

    // Act and Assert
    assertEquals(source, PropertyDecrypter.getDecryptedProperties(source));
  }
