...
public class TransportableWrappedKeyDiffblueTest {
  ...
  public void testNewTransportableWrappedKey_thenReturnIvIsAxaxaxaxBytesIsUtf8()
    ...
    TransportableWrappedKey actualTransportableWrappedKey =
        new TransportableWrappedKey("AXAXAXAX".getBytes("UTF-8"), "AXAXAXAX".getBytes("UTF-8"));

    // Assert
    assertArrayEquals("AXAXAXAX".getBytes("UTF-8"), actualTransportableWrappedKey.getIv());
    assertArrayEquals(
        "AXAXAXAX".getBytes("UTF-8"), actualTransportableWrappedKey.getWrappedKeyBytes());
    assertArrayEquals(
