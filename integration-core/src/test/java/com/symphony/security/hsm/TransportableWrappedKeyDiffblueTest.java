...
public class TransportableWrappedKeyDiffblueTest {
   ...
   * <ul>
   *   <li>Then return Iv is {@code AXAXAXAX} Bytes is {@code UTF-8}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TransportableWrappedKey#TransportableWrappedKey(byte[], byte[])}
   */
  @Test
  @MethodsUnderTest({"void TransportableWrappedKey.<init>(byte[], byte[])"})
  public void testNewTransportableWrappedKey_thenReturnIvIsAxaxaxaxBytesIsUtf8() throws IOException {
    // Arrange
    byte[] wrappedKeyBytes = "AXAXAXAX".getBytes("UTF-8");

    // Act
    TransportableWrappedKey actualTransportableWrappedKey = new TransportableWrappedKey(wrappedKeyBytes,
   ...
   * <ul>
   *   <li>When {@code A}.</li>
   *   <li>Then return WrappedKeyBytes is empty array of {@code byte}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TransportableWrappedKey#TransportableWrappedKey(byte[])}
   */
  @Test
  @MethodsUnderTest({"void TransportableWrappedKey.<init>(byte[])"})
  public void testNewTransportableWrappedKey_whenA_thenReturnWrappedKeyBytesIsEmptyArrayOfByte() throws IOException {
    // Arrange and Act
    TransportableWrappedKey actualTransportableWrappedKey = new TransportableWrappedKey(
  ...
  @Test
  @MethodsUnderTest({"void TransportableWrappedKey.<init>(byte[])"})
  public void testNewTransportableWrappedKey_whenAxaxaxaxBytesIsUtf8_thenThrowIOException() throws IOException {
    // Arrange, Act and Assert
    thrown.expect(IOException.class);
