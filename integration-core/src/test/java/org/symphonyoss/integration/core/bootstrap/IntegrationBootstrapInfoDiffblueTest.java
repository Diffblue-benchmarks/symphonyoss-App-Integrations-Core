...
public class IntegrationBootstrapInfoDiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link IntegrationBootstrapInfo#IntegrationBootstrapInfo(String, Integration)}
   ...
   */
  @Test
  @MethodsUnderTest({"void IntegrationBootstrapInfo.<init>(String, Integration)",
      "String IntegrationBootstrapInfo.getConfigurationType()", "Integration IntegrationBootstrapInfo.getIntegration()",
      "int IntegrationBootstrapInfo.getRetryAttemptCounter()"})
  ...
  /**
   * Test {@link IntegrationBootstrapInfo#registerRetryAttempt()}.
   * <p>
   * Method under test: {@link IntegrationBootstrapInfo#registerRetryAttempt()}
   */
  @Test
  @MethodsUnderTest({"int IntegrationBootstrapInfo.registerRetryAttempt()"})
