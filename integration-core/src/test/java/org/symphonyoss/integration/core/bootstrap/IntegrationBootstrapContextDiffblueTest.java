...
public class IntegrationBootstrapContextDiffblueTest {
   ...
   * <p>
   * Method under test: {@link IntegrationBootstrapContext#getIntegrationById(String)}
   */
  @Test
  @MethodsUnderTest({"org.symphonyoss.integration.Integration IntegrationBootstrapContext.getIntegrationById(String)"})
