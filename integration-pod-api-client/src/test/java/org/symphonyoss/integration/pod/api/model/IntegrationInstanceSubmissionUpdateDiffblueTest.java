...
public class IntegrationInstanceSubmissionUpdateDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void IntegrationInstanceSubmissionUpdate.<init>()",
  ...
  public void testGettersAndSetters() {
    // Arrange and Act
    IntegrationInstanceSubmissionUpdate actualIntegrationInstanceSubmissionUpdate =
        new IntegrationInstanceSubmissionUpdate();
    ...
    assertEquals(
        "Optional Properties", actualIntegrationInstanceSubmissionUpdate.getOptionalProperties());
  }
}
