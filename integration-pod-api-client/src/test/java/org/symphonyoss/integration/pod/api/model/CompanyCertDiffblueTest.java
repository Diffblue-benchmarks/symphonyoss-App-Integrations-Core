...
public class CompanyCertDiffblueTest {
  ...
  @MethodsUnderTest({"void CompanyCert.<init>()", "CompanyCertAttributes CompanyCert.getAttributes()",
      "String CompanyCert.getPem()", "void CompanyCert.setAttributes(CompanyCertAttributes)",
