...
public class IntegrationInstanceApiClientDiffblueTest {
  ...
  /**
   * Method under test:
   * {@link IntegrationInstanceApiClient#createInstance(String, IntegrationInstanceSubmissionCreate)}
   */
  @Test
   ...
   */
  @Test
  public void testCreateInstance2() throws RemoteApiException {
    // Arrange
   ...
   */
  @Test
  public void testCreateInstance3() throws RemoteApiException {
    // Arrange
    IntegrationInstanceSubmissionCreate instance = mock(IntegrationInstanceSubmissionCreate.class);
   ...
   * <ul>
   *   <li>
   * {@link IntegrationInstanceApiClient#IntegrationInstanceApiClient(HttpApiClient, LogMessageSource)}
