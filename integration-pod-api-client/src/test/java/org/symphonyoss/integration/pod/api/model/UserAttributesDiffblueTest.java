...
public class UserAttributesDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"void UserAttributes.<init>()", "AccountTypeEnum UserAttributes.getAccountType()",
      "List UserAttributes.getAssetClasses()", "String UserAttributes.getDepartment()",
      "String UserAttributes.getDisplayName()", "String UserAttributes.getDivision()",
      "String UserAttributes.getEmailAddress()", "String UserAttributes.getFirstName()",
      "List UserAttributes.getIndustries()", "String UserAttributes.getJobFunction()",
      "String UserAttributes.getLastName()", "String UserAttributes.getLocation()",
      "String UserAttributes.getMobilePhoneNumber()", "String UserAttributes.getSmsNumber()",
      "String UserAttributes.getTitle()", "String UserAttributes.getUserName()",
      "String UserAttributes.getWorkPhoneNumber()", "void UserAttributes.setAccountType(AccountTypeEnum)",
      "void UserAttributes.setAssetClasses(List)", "void UserAttributes.setDepartment(String)",
