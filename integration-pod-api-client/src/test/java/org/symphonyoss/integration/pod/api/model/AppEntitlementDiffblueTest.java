...
public class AppEntitlementDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"void AppEntitlement.<init>()", "String AppEntitlement.getAppId()",
      "String AppEntitlement.getAppName()", "Boolean AppEntitlement.getEnable()", "Boolean AppEntitlement.getInstall()",
      "Boolean AppEntitlement.getListed()", "void AppEntitlement.setAppId(String)",
      "void AppEntitlement.setAppName(String)", "void AppEntitlement.setEnable(Boolean)",
      "void AppEntitlement.setInstall(Boolean)", "void AppEntitlement.setListed(Boolean)"})
