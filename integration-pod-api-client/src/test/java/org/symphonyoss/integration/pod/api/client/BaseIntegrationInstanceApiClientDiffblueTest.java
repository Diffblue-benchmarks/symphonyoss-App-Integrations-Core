...
public class BaseIntegrationInstanceApiClientDiffblueTest {
  ...
  public void testUpdateInstance_givenEmptyString() throws RemoteApiException {
    ...
    when(instance.getInstanceId()).thenReturn("");
    doNothing().when(instance).setConfigurationId(Mockito.<String>any());
    doNothing().when(instance).setInstanceId(Mockito.<String>any());
    doNothing().when(instance).setName(Mockito.<String>any());
    doNothing().when(instance).setOptionalProperties(Mockito.<String>any());
  ...
  public void testUpdateInstance_givenHttpApiClient_whenNull_thenThrowRemoteApiException()
      throws RemoteApiException {
    // Arrange, Act and Assert
    thrown.expect(RemoteApiException.class);
    baseIntegrationInstanceApiClient.updateInstance("ABC123", null);
  }
   ...
   *
   * <ul>
   *   <li>Given {@code integration.pod.base.integration.instance.api.client.id.empty}.
   * </ul>
   *
   * <p>Method under test: {@link BaseIntegrationInstanceApiClient#updateInstance(String,
   * IntegrationInstanceSubmissionUpdate)}
  ...
  public void testUpdateInstance_givenIntegrationPodBaseIntegrationInstanceApiClientIdEmpty()
      throws RemoteApiException {
    // Arrange
    IntegrationInstanceSubmissionUpdate instance = mock(IntegrationInstanceSubmissionUpdate.class);
    when(instance.getConfigurationId())
        .thenReturn("integration.pod.base.integration.instance.api.client.id.empty");
    when(instance.getInstanceId()).thenReturn(null);
    doNothing().when(instance).setConfigurationId(Mockito.<String>any());
    doNothing().when(instance).setInstanceId(Mockito.<String>any());
    doNothing().when(instance).setName(Mockito.<String>any());
  ...
  public void testUpdateInstance_givenName_whenNull_thenThrowRemoteApiException()
      throws RemoteApiException {
    // Arrange
    IntegrationInstanceSubmissionUpdate instance = new IntegrationInstanceSubmissionUpdate();
    instance.setConfigurationId("42");
  ...
  public void testListInstances_givenHttpApiClient_whenNull_thenThrowRemoteApiException2()
      throws RemoteApiException {
    // Arrange, Act and Assert
    thrown.expect(RemoteApiException.class);
  ...
  public void testListInstances_thenReturnEmpty() throws RemoteApiException {
    // Arrange
    ...
    when(httpApiClient.doGet(
            ...
            Mockito.<Map<String, String>>any(),
            Mockito.<Class<Object>>any()))
        .thenReturn(integrationInstanceList);
    when(httpApiClient.escapeString(Mockito.<String>any()))
        .thenReturn("https://example.org/example");
