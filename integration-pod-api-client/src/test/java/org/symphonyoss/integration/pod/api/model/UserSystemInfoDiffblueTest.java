...
public class UserSystemInfoDiffblueTest {
   ...
   *   <li>{@link UserSystemInfo#setStatus(UserSystemInfo.StatusEnum)}
  ...
  public void testGettersAndSetters() {
    ...
    actualUserSystemInfo.setStatus(UserSystemInfo.StatusEnum.ENABLED);
    ...
    UserSystemInfo.StatusEnum actualStatus = actualUserSystemInfo.getStatus();
    ...
    assertEquals(UserSystemInfo.StatusEnum.ENABLED, actualStatus);
  }
}
