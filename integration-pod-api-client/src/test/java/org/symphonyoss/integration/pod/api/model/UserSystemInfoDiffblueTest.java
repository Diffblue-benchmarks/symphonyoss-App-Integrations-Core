...
public class UserSystemInfoDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"void UserSystemInfo.<init>()", "String UserSystemInfo.getCreatedBy()",
      ...
      "StatusEnum UserSystemInfo.getStatus()", "void UserSystemInfo.setCreatedBy(String)",
