...
public class CompanyCertInfoDiffblueTest {
  ...
  @MethodsUnderTest({"void CompanyCertInfo.<init>()", "String CompanyCertInfo.getCommonName()",
      "Long CompanyCertInfo.getExpiryDate()", "String CompanyCertInfo.getFingerPrint()",
      "String CompanyCertInfo.getIssuerFingerPrint()", "Long CompanyCertInfo.getLastSeen()",
      "Long CompanyCertInfo.getUpdatedAt()", "Long CompanyCertInfo.getUpdatedBy()",
      "void CompanyCertInfo.setCommonName(String)", "void CompanyCertInfo.setExpiryDate(Long)",
      "void CompanyCertInfo.setFingerPrint(String)", "void CompanyCertInfo.setIssuerFingerPrint(String)",
      "void CompanyCertInfo.setLastSeen(Long)", "void CompanyCertInfo.setUpdatedAt(Long)",
