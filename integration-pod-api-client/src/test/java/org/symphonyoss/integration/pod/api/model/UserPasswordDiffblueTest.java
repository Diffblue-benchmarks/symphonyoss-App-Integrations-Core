...
public class UserPasswordDiffblueTest {
   ...
   *
   * <p>Method under test: {@link UserPassword#gethSalt()}
   */
  @Test
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link UserPassword#gethPassword()}
   */
  @Test
  @ManagedByDiffblue
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void UserPassword.<init>()",
    "String UserPassword.getKhPassword()",
    "String UserPassword.getKhSalt()",
    "void UserPassword.setKhPassword(String)",
    "void UserPassword.setKhSalt(String)",
    "void UserPassword.sethPassword(String)",
