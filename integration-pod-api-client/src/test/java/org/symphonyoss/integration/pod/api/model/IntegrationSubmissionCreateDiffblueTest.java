...
public class IntegrationSubmissionCreateDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void IntegrationSubmissionCreate.<init>()",
    "Map IntegrationSubmissionCreate.getData()",
    "String IntegrationSubmissionCreate.getDescription()",
    "String IntegrationSubmissionCreate.getName()",
    "String IntegrationSubmissionCreate.getType()",
    "String IntegrationSubmissionCreate.getUsername()",
    "void IntegrationSubmissionCreate.setData(Map)",
    "void IntegrationSubmissionCreate.setDescription(String)",
    "void IntegrationSubmissionCreate.setName(String)",
    "void IntegrationSubmissionCreate.setType(String)",
    "void IntegrationSubmissionCreate.setUsername(String)"
  })
  public void testGettersAndSetters() {
    // Arrange and Act
    IntegrationSubmissionCreate actualIntegrationSubmissionCreate =
        new IntegrationSubmissionCreate();
