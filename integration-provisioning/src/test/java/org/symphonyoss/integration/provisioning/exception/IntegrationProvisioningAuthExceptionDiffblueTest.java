...
public class IntegrationProvisioningAuthExceptionDiffblueTest {
  /**
   * Test {@link IntegrationProvisioningAuthException#IntegrationProvisioningAuthException(String,
   * Throwable, String[])}.
   *
   * <p>Method under test: {@link
   * IntegrationProvisioningAuthException#IntegrationProvisioningAuthException(String, Throwable,
   * String[])}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void IntegrationProvisioningAuthException.<init>(String, Throwable, String[])"
  })
  public void testNewIntegrationProvisioningAuthException() {
    ...
    // Act
    IntegrationProvisioningAuthException actualIntegrationProvisioningAuthException =
        new IntegrationProvisioningAuthException("0123456789ABCDEF", cause, "0123456789ABCDEF");
  ...
  public void testNewIntegrationProvisioningAuthException2() {
    ...
    // Act
    IntegrationProvisioningAuthException actualIntegrationProvisioningAuthException =
        new IntegrationProvisioningAuthException("", cause, "0123456789ABCDEF");
  ...
  public void testNewIntegrationProvisioningAuthException3() {
    // Arrange and Act
    IntegrationProvisioningAuthException actualIntegrationProvisioningAuthException =
        new IntegrationProvisioningAuthException("0123456789ABCDEF", null, "0123456789ABCDEF");
  ...
  public void testNewIntegrationProvisioningAuthException_thenReturnLocalizedMessageIsAString() {
    ...
    // Act
    IntegrationProvisioningAuthException actualIntegrationProvisioningAuthException =
        new IntegrationProvisioningAuthException("0123456789ABCDEF", cause);
