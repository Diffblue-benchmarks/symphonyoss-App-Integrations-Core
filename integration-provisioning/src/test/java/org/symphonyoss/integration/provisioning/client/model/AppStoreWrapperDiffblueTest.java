...
public class AppStoreWrapperDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"void AppStoreWrapper.<init>()", "String AppStoreWrapper.getAppGroupId()",
      "AppStoreAssetsWrapper AppStoreWrapper.getAssets()", "String AppStoreWrapper.getDescription()",
      "String AppStoreWrapper.getDomain()", "Boolean AppStoreWrapper.getEnabled()", "String AppStoreWrapper.getId()",
      "String AppStoreWrapper.getName()", "String AppStoreWrapper.getPublisher()",
      "AppStoreSettingsWrapper AppStoreWrapper.getSettings()", "Boolean AppStoreWrapper.getSymphonyManaged()",
      "String AppStoreWrapper.getType()", "String AppStoreWrapper.getVersion()",
      "void AppStoreWrapper.setAppGroupId(String)", "void AppStoreWrapper.setAssets(AppStoreAssetsWrapper)",
      "void AppStoreWrapper.setDescription(String)", "void AppStoreWrapper.setDomain(String)",
      "void AppStoreWrapper.setEnabled(Boolean)", "void AppStoreWrapper.setId(String)",
      "void AppStoreWrapper.setName(String)", "void AppStoreWrapper.setPublisher(String)",
      "void AppStoreWrapper.setSettings(AppStoreSettingsWrapper)", "void AppStoreWrapper.setSymphonyManaged(Boolean)",
      "void AppStoreWrapper.setType(String)", "void AppStoreWrapper.setVersion(String)"})
