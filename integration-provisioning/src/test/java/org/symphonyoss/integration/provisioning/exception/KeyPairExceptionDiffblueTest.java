...
public class KeyPairExceptionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link KeyPairException#KeyPairException(String, Throwable, String[])}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link KeyPairException#KeyPairException(String, String[])}
   */
  @Test
  ...
  @Test
  @MethodsUnderTest({"void KeyPairException.<init>(String, Throwable, String[])"})
  public void testNewKeyPairException_whenNull_thenReturnCauseIsNull() {
    // Arrange and Act
  ...
  @Test
  @MethodsUnderTest({"void KeyPairException.<init>(String, String[])"})
  public void testNewKeyPairException_whenNull_thenReturnLocalizedMessageIsAString() {
    // Arrange and Act
