...
public class IntegrationProvisioningServiceDiffblueTest {
  @MockBean private AppKeyPairService appKeyPairService;

  @Autowired private ApplicationContext applicationContext;

  @MockBean private ApplicationService applicationService;

  @MockBean private CompanyCertificateService companyCertificateService;

  @MockBean private ConfigurationProvisioningService configurationProvisioningService;

  @Autowired private IntegrationProperties integrationProperties;

  @Autowired private IntegrationProvisioningService integrationProvisioningService;

  @MockBean private LogMessageSource logMessageSource;

  @MockBean private UserKeyPairService userKeyPairService;
   ...
   *
   * <p>Method under test: {@link IntegrationProvisioningService#configure()}
   */
  @Test
  @ManagedByDiffblue
