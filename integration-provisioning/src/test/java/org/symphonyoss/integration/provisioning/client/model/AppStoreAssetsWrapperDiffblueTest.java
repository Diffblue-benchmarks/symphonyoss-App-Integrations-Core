...
public class AppStoreAssetsWrapperDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void AppStoreAssetsWrapper.<init>()",
    "String AppStoreAssetsWrapper.getIconUrl()",
    "String AppStoreAssetsWrapper.getLoadUrl()",
    "void AppStoreAssetsWrapper.setIconUrl(String)",
