...
public class AppStoreSettingsWrapperDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void AppStoreSettingsWrapper.<init>()",
    "String AppStoreSettingsWrapper.getAppType()",
    "boolean AppStoreSettingsWrapper.isEnabled()",
    "boolean AppStoreSettingsWrapper.isInstall()",
    "boolean AppStoreSettingsWrapper.isVisible()",
    "void AppStoreSettingsWrapper.setAppType(String)",
    "void AppStoreSettingsWrapper.setEnabled(boolean)",
    "void AppStoreSettingsWrapper.setInstall(boolean)",
