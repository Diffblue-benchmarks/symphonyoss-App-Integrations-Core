...
public class UsernameMismatchExceptionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link UsernameMismatchException#UsernameMismatchException(String, String[])}
   */
  @Test
  ...
  @Test
  @MethodsUnderTest({"void UsernameMismatchException.<init>(String, String[])"})
  public void testNewUsernameMismatchException_whenNull_thenReturnLocalizedMessageIsAString() {
    // Arrange and Act
