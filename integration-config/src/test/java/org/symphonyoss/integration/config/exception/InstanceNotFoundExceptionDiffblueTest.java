...
public class InstanceNotFoundExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link InstanceNotFoundException#InstanceNotFoundException(String,
   * String[])}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewInstanceNotFoundException() {
    // Arrange and Act
    InstanceNotFoundException actualInstanceNotFoundException =
        new InstanceNotFoundException("An error occurred", "Solutions");
