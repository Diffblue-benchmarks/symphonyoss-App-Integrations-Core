...
public class SaveConfigurationExceptionDiffblueTest {
  /**
   * Test {@link SaveConfigurationException#SaveConfigurationException(String, Throwable,
   * String[])}.
   *
   * <p>Method under test: {@link SaveConfigurationException#SaveConfigurationException(String,
   * Throwable, String[])}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewSaveConfigurationException() {
    ...
    // Act
    SaveConfigurationException actualSaveConfigurationException =
        new SaveConfigurationException("An error occurred", cause, "Solutions");
