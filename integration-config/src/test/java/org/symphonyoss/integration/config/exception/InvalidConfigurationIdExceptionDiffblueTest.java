...
public class InvalidConfigurationIdExceptionDiffblueTest {
   ...
   * InvalidConfigurationIdException#InvalidConfigurationIdException(String, String)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewInvalidConfigurationIdException() {
    // Arrange and Act
    InvalidConfigurationIdException actualInvalidConfigurationIdException =
        new InvalidConfigurationIdException("An error occurred", "Solution");
