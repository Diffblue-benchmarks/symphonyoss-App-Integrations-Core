...
public class InitializationConfigExceptionDiffblueTest {
  /**
   * Test {@link InitializationConfigException#InitializationConfigException(String, Throwable,
   * String)}.
   *
   * <p>Method under test: {@link
   * InitializationConfigException#InitializationConfigException(String, Throwable, String)}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewInitializationConfigException() {
    ...
    // Act
    InitializationConfigException actualInitializationConfigException =
        new InitializationConfigException("An error occurred", cause, "Solution");
