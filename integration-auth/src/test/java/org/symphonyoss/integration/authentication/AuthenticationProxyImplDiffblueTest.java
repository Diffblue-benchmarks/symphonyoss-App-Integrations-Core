...
public class AuthenticationProxyImplDiffblueTest {
   ...
   * <ul>
   *   <li>When {@code 42}.</li>
   *   <li>Then throw {@link UnregisteredUserAuthException}.</li>
   * </ul>
   * <p>
  ...
  public void testAuthenticate_when42_thenThrowUnregisteredUserAuthException() throws AuthenticationException {
  ...
  public void testIsAuthenticated_whenUser_thenThrowUnregisteredUserAuthException() {
    // Arrange, Act and Assert
    thrown.expect(UnregisteredUserAuthException.class);
  ...
  public void testInvalidate_when42_thenThrowUnregisteredUserAuthException() {
    // Arrange, Act and Assert
    thrown.expect(UnregisteredUserAuthException.class);
  ...
  public void testGetToken_when42_thenThrowUnregisteredUserAuthException() {
    // Arrange, Act and Assert
    thrown.expect(UnregisteredUserAuthException.class);
  ...
  public void testGetSessionToken_when42_thenThrowUnregisteredUserAuthException() {
    // Arrange, Act and Assert
    thrown.expect(UnregisteredUserAuthException.class);
   ...
   * <p>
   * Method under test: {@link AuthenticationProxyImpl#reAuthSessionOrThrow(String, RemoteApiException)}
   */
  @Test
  @MethodsUnderTest({
   ...
   * <p>
   * Method under test: {@link AuthenticationProxyImpl#sessionNoLongerEntitled(int)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link AuthenticationProxyImpl#httpClientForUser(String, ServiceName)}
   */
  @Test
  @MethodsUnderTest({"javax.ws.rs.client.Client AuthenticationProxyImpl.httpClientForUser(String, ServiceName)"})
   ...
   * <p>
   * Method under test: {@link AuthenticationProxyImpl#httpClientForSessionToken(String, ServiceName)}
   */
  @Test
  @MethodsUnderTest({
