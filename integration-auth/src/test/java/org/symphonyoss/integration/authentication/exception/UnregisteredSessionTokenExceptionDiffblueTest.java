...
public class UnregisteredSessionTokenExceptionDiffblueTest {
  /**
   * Test {@link UnregisteredSessionTokenException#UnregisteredSessionTokenException(String, String[])}.
   * <p>
   * Method under test: {@link UnregisteredSessionTokenException#UnregisteredSessionTokenException(String, String[])}
   */
  @Test
