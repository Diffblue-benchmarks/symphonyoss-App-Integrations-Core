...
public class AppAuthenticationProxyImplDiffblueTest {
   ...
   * <p>
   * Method under test: {@link AppAuthenticationProxyImpl#httpClientForApplication(String, ServiceName)}
   */
  @Test
  @MethodsUnderTest({
   ...
   * <p>
   * Method under test: {@link AppAuthenticationProxyImpl#authenticate(String, String)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link AppAuthenticationProxyImpl#getPodPublicCertificate(String)}
   */
  @Test
