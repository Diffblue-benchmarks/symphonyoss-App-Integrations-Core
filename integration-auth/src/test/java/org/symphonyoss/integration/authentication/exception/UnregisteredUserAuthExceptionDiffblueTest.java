...
public class UnregisteredUserAuthExceptionDiffblueTest {
   ...
   * UnregisteredUserAuthException#UnregisteredUserAuthException(String, String[])}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewUnregisteredUserAuthException() {
    // Arrange and Act
    UnregisteredUserAuthException actualUnregisteredUserAuthException =
        new UnregisteredUserAuthException("0123456789ABCDEF", "0123456789ABCDEF");
