...
public class AuthenticationApiClientDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link Token} (default constructor) Name is {@code /v1/authenticate}.
   *   <li>Then return {@link Token} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link AuthenticationApiClient#authenticate(String)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({"Token AuthenticationApiClient.authenticate(String)"})
  public void testAuthenticate_givenTokenNameIsV1Authenticate_thenReturnToken()
