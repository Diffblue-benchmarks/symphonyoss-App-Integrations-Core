...
public class AuthenticationAppApiClientDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.symphonyoss.integration.authentication.api.model.AppToken AuthenticationAppApiClient.authenticate(String, String)"
  })
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.symphonyoss.integration.authentication.api.model.PodCertificate AuthenticationAppApiClient.getPodPublicCertificate(String)"
  })
