...
public class UnexpectedAppAuthenticationExceptionDiffblueTest {
  /**
   * Test {@link UnexpectedAppAuthenticationException#UnexpectedAppAuthenticationException(String,
   * Throwable, String[])}.
   *
   * <p>Method under test: {@link
   * UnexpectedAppAuthenticationException#UnexpectedAppAuthenticationException(String, Throwable,
   * String[])}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void UnexpectedAppAuthenticationException.<init>(String, Throwable, String[])"
  })
  public void testNewUnexpectedAppAuthenticationException() {
    ...
    // Act
    UnexpectedAppAuthenticationException actualUnexpectedAppAuthenticationException =
        new UnexpectedAppAuthenticationException("An error occurred", cause, "Solutions");
