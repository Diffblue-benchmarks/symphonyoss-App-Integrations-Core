...
public class InvalidAppTokenExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link InvalidAppTokenException#InvalidAppTokenException(String,
   * Throwable, String[])}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewInvalidAppTokenException() {
    ...
    // Act
    InvalidAppTokenException actualInvalidAppTokenException =
        new InvalidAppTokenException("An error occurred", e, "Solutions");
