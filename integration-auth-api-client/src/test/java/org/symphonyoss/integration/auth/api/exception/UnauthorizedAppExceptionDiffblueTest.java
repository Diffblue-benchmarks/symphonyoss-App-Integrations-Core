...
public class UnauthorizedAppExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link UnauthorizedAppException#UnauthorizedAppException(String,
   * Throwable, String[])}
   */
  @Test
  @ManagedByDiffblue
  ...
  public void testNewUnauthorizedAppException() {
    ...
    // Act
    UnauthorizedAppException actualUnauthorizedAppException =
        new UnauthorizedAppException("An error occurred", e, "Solutions");
