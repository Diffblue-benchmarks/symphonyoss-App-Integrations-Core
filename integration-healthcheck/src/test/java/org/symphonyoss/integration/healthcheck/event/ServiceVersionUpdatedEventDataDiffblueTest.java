...
public class ServiceVersionUpdatedEventDataDiffblueTest {
   ...
   *
   * <ul>
   *   <li>{@link ServiceVersionUpdatedEventData#ServiceVersionUpdatedEventData(String, String,
   *       String)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ServiceVersionUpdatedEventData.<init>(String, String, String)",
    "String ServiceVersionUpdatedEventData.getNewVersion()",
    "String ServiceVersionUpdatedEventData.getOldVersion()",
    "String ServiceVersionUpdatedEventData.getServiceName()"
  })
  public void testGettersAndSetters() {
    // Arrange and Act
    ServiceVersionUpdatedEventData actualServiceVersionUpdatedEventData =
        new ServiceVersionUpdatedEventData("Service Name", "1.0.1", "1.0.3");
