...
@ContextConfiguration(
    classes = {PodSessionManagerHealthIndicator.class, IntegrationProperties.class})
...
public class PodSessionManagerHealthIndicatorDiffblueTest {
  ...
  @Autowired private PodSessionManagerHealthIndicator podSessionManagerHealthIndicator;

  /**
   * Test {@link PodSessionManagerHealthIndicator#getServiceName()}.
   *
   * <p>Method under test: {@link PodSessionManagerHealthIndicator#getServiceName()}
   */
  @Test
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link PodSessionManagerHealthIndicator#getFriendlyServiceName()}
   */
  @Test
  @ManagedByDiffblue
