...
public class KmAuthHealthInvokerDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"ServiceHealthIndicator KmAuthHealthInvoker.getHealthIndicator()",
      "String KmAuthHealthInvoker.getServiceField()", "ServiceName KmAuthHealthInvoker.getServiceName()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link KmAuthHealthInvoker#handleHealthResponse(IntegrationBridgeServiceInfo, String)}
   */
  @Test
  @MethodsUnderTest({"void KmAuthHealthInvoker.handleHealthResponse(IntegrationBridgeServiceInfo, String)"})
