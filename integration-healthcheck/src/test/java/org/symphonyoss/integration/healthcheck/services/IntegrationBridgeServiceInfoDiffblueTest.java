...
public class IntegrationBridgeServiceInfoDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String IntegrationBridgeServiceInfo.getCurrentVersion()"})
  public void testGetCurrentVersion_thenReturn102() {
    // Arrange
    IntegrationBridgeServiceInfo integrationBridgeServiceInfo =
        new IntegrationBridgeServiceInfo("1.0.2", "https://example.org/example");
    ...
    // Act and Assert
    assertEquals("1.0.2", integrationBridgeServiceInfo.getCurrentVersion());
  }
  ...
  public void testGetCompatibility4() {
    // Arrange
    IntegrationBridgeServiceInfo integrationBridgeServiceInfo =
        new IntegrationBridgeServiceInfo("42", "https://example.org/example");
    integrationBridgeServiceInfo.setCurrentVersion("1.0.2");
  ...
  public void testGetCompatibility6() {
    ...
    IntegrationBridgeServiceInfo integrationBridgeServiceInfo =
        new IntegrationBridgeServiceInfo("1.0.2", "https://example.org/example");
    integrationBridgeServiceInfo.setCurrentVersion("1.0.21.0.2");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Compability IntegrationBridgeServiceInfo.getCompatibility()"})
  public void testGetCompatibility7() {
    // Arrange
    IntegrationBridgeServiceInfo integrationBridgeServiceInfo =
        new IntegrationBridgeServiceInfo("1.0.2", "https://example.org/example");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Compability IntegrationBridgeServiceInfo.getCompatibility()"})
  public void testGetCompatibility8() {
    // Arrange
    IntegrationBridgeServiceInfo integrationBridgeServiceInfo =
        new IntegrationBridgeServiceInfo("1.0.2", "https://example.org/example");
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(integrationBridgeServiceInfo.hashCode(), integrationBridgeServiceInfo2.hashCode());
  }
