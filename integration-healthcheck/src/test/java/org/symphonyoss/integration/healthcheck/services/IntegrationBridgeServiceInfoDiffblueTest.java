...
public class IntegrationBridgeServiceInfoDiffblueTest {
   ...
   * <p>
   * Method under test: {@link IntegrationBridgeServiceInfo#IntegrationBridgeServiceInfo(String, String)}
   */
  @Test
  ...
  @Test
  @MethodsUnderTest({"String IntegrationBridgeServiceInfo.getMinVersion()"})
  public void testGetMinVersion_thenReturnNA() {
    // Arrange, Act and Assert
  ...
  public void testGetCompatibility_thenReturnUnknown() {
    // Arrange, Act and Assert
    assertEquals(Compability.UNKNOWN,
   ...
   */
  @Test
  @MethodsUnderTest({"String IntegrationBridgeServiceInfo.getUrl()",
      "void IntegrationBridgeServiceInfo.setConnectivity(Status)",
      "void IntegrationBridgeServiceInfo.setCurrentVersion(String)", "String IntegrationBridgeServiceInfo.toString()"})
  ...
  /**
   * Test {@link IntegrationBridgeServiceInfo#equals(Object)}, and {@link IntegrationBridgeServiceInfo#hashCode()}.
   * <ul>
   ...
   */
  @Test
  @MethodsUnderTest({"boolean IntegrationBridgeServiceInfo.equals(Object)",
