...
public class IntegrationHealthIndicatorAdapterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link TestWebHookIntegration} (default constructor) onCreate {@code null}.
  ...
  public void testHealth_givenTestWebHookIntegrationOnCreateNull_thenReturnDetailsSizeIsOne() {
    // Arrange
    TestWebHookIntegration integration = new TestWebHookIntegration();
    integration.onCreate(null);
    ...
    assertNull(((IntegrationHealth) getResult).getName());
