...
public class KmHealthInvokerDiffblueTest {
  ...
  @Autowired private KmHealthInvoker kmHealthInvoker;
   ...
   *
   * <p>Method under test: {@link KmHealthInvoker#getHealthCheckUrl()}
   */
  @Test
  @ManagedByDiffblue
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ServiceHealthIndicator KmHealthInvoker.getHealthIndicator()",
   ...
   *
   * <p>Method under test: {@link KmHealthInvoker#getServiceBaseUrl()}
   */
  @Test
  @ManagedByDiffblue
