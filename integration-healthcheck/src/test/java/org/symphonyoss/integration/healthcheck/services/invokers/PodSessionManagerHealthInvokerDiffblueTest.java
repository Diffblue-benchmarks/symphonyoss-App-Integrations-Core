...
public class PodSessionManagerHealthInvokerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link PodSessionManagerHealthInvoker#getFriendlyServiceName()}
   */
  @Test
   ...
   */
  @Test
  @MethodsUnderTest({"ServiceHealthIndicator PodSessionManagerHealthInvoker.getHealthIndicator()",
