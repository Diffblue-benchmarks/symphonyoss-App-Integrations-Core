...
public class SchedulerConfigurationDiffblueTest {
   ...
   * <ul>
   *   <li>Then {@link ScheduledTaskRegistrar} (default constructor) Scheduler {@link ConcurrentTaskScheduler}.</li>
   * </ul>
   * <p>
   * Method under test: {@link SchedulerConfiguration#configureTasks(ScheduledTaskRegistrar)}
   */
  @Test
