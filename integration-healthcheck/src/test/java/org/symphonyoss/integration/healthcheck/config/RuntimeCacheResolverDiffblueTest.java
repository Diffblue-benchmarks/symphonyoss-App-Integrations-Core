...
public class RuntimeCacheResolverDiffblueTest {
   ...
   * <p>
   * Method under test: {@link RuntimeCacheResolver#RuntimeCacheResolver(CacheManager)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link RuntimeCacheResolver#getCacheNames(CacheOperationInvocationContext)}
   */
  @Test
  @MethodsUnderTest({"Collection RuntimeCacheResolver.getCacheNames(CacheOperationInvocationContext)"})
