...
public class V4MessageApiClientDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link Message} (default constructor) Data is {@code /v4/stream/}.</li>
   *   <li>Then return {@link Message} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link V4MessageApiClient#postMessage(String, String, String, Message)}
   */
  @Test
  @MethodsUnderTest({"Message V4MessageApiClient.postMessage(String, String, String, Message)"})
  public void testPostMessage_givenMessageDataIsV4Stream_thenReturnMessage() throws RemoteApiException {
    // Arrange
    ...
    when(apiClient.doPost(Mockito.<String>any(), Mockito.<Map<String, String>>any(), Mockito.<Map<String, String>>any(),
        Mockito.<Object>any(), Mockito.<Class<Object>>any())).thenReturn(message);
    ...
    V4MessageApiClient v4MessageApiClient = new V4MessageApiClient(apiClient, new LogMessageSource());
    ...
    // Act
    Message actualPostMessageResult = v4MessageApiClient.postMessage("ABC123", "ABC123", "42", message2);
