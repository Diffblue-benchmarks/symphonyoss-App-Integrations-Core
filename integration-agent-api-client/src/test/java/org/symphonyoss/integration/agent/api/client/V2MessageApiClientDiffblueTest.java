...
public class V2MessageApiClientDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link Message} (default constructor) Data is {@code /v2/stream/}.</li>
   *   <li>Then return {@link Message} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link V2MessageApiClient#postMessage(String, String, String, Message)}
   */
  @Test
  @MethodsUnderTest({"Message V2MessageApiClient.postMessage(String, String, String, Message)"})
  public void testPostMessage_givenMessageDataIsV2Stream_thenReturnMessage() throws RemoteApiException {
    // Arrange
    ...
    V2MessageApiClient v2MessageApiClient = new V2MessageApiClient(apiClient, new LogMessageSource());
    ...
    // Act
    Message actualPostMessageResult = v2MessageApiClient.postMessage("ABC123", "ABC123", "42", message2);
