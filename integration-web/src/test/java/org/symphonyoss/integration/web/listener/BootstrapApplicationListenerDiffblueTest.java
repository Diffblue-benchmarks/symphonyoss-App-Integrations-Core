...
public class BootstrapApplicationListenerDiffblueTest {
  /**
   * Test {@link BootstrapApplicationListener#onApplicationEvent(ApplicationEnvironmentPreparedEvent)} with {@code ApplicationEnvironmentPreparedEvent}.
   * <p>
   * Method under test: {@link BootstrapApplicationListener#onApplicationEvent(ApplicationEnvironmentPreparedEvent)}
   */
  @Test
  @MethodsUnderTest({"void BootstrapApplicationListener.onApplicationEvent(ApplicationEnvironmentPreparedEvent)"})
