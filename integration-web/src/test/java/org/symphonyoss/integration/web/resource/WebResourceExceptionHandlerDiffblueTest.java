...
@ContextConfiguration(classes = {WebResourceExceptionHandler.class})
@RunWith(SpringJUnit4ClassRunner.class)
public class WebResourceExceptionHandlerDiffblueTest {
  @Autowired private WebResourceExceptionHandler webResourceExceptionHandler;

  /**
   * Test {@link
   * WebResourceExceptionHandler#handleUnavailableException(IntegrationUnavailableException)}.
   *
   * <ul>
   *   <li>Then return Body Message is a string.
   * </ul>
   *
  ...
  public void testHandleUnavailableException_thenReturnBodyMessageIsAString() {
    // Arrange and Act
    ResponseEntity<ErrorResponse> actualHandleUnavailableExceptionResult =
        webResourceExceptionHandler.handleUnavailableException(
    ...
    assertEquals(
        HttpStatus.SERVICE_UNAVAILABLE, actualHandleUnavailableExceptionResult.getStatusCode());
   ...
   *
   * <p>Method under test: {@link
   * WebResourceExceptionHandler#handleRemoteAPIException(RemoteApiException)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ResponseEntity WebResourceExceptionHandler.handleRemoteAPIException(RemoteApiException)"
  })
  public void testHandleRemoteAPIException_thenReturnBodyMessageIsAString() {
    // Arrange and Act
    ResponseEntity<ErrorResponse> actualHandleRemoteAPIExceptionResult =
        webResourceExceptionHandler.handleRemoteAPIException(
  ...
  /**
   * Test {@link
   * WebResourceExceptionHandler#handleUnauthorizedException(UnauthorizedUserException)}.
   *
   * <ul>
   *   <li>Then return Body Message is a string.
   * </ul>
  ...
  public void testHandleUnauthorizedException_thenReturnBodyMessageIsAString() {
    // Arrange and Act
    ResponseEntity<ErrorResponse> actualHandleUnauthorizedExceptionResult =
        webResourceExceptionHandler.handleUnauthorizedException(
   ...
   *
   * <p>Method under test: {@link
   * WebResourceExceptionHandler#handleForbiddenException(AuthenticationException)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ResponseEntity WebResourceExceptionHandler.handleForbiddenException(AuthenticationException)"
  })
  public void testHandleForbiddenException_thenReturnBodyMessageIsAString() {
    // Arrange and Act
    ResponseEntity<ErrorResponse> actualHandleForbiddenExceptionResult =
        webResourceExceptionHandler.handleForbiddenException(
  ...
  /**
   * Test {@link
   * WebResourceExceptionHandler#handleMissingRequiredParameterException(MissingRequiredParameterException)}.
   *
   * <p>Method under test: {@link
   * WebResourceExceptionHandler#handleMissingRequiredParameterException(MissingRequiredParameterException)}
   */
  ...
  public void testHandleMissingRequiredParameterException() {
    // Arrange and Act
    ResponseEntity<ErrorResponse> actualHandleMissingRequiredParameterExceptionResult =
        webResourceExceptionHandler.handleMissingRequiredParameterException(
    ...
    assertEquals(
        ...
        actualHandleMissingRequiredParameterExceptionResult.getStatusCode());
