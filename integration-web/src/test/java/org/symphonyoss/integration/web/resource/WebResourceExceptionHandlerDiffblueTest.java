...
public class WebResourceExceptionHandlerDiffblueTest {
  /**
   * Method under test:
   * {@link WebResourceExceptionHandler#handleUnavailableException(IntegrationUnavailableException)}
   */
  @Test
  public void testHandleUnavailableException() {
    // Arrange
  ...
  /**
   * Method under test:
   * {@link WebResourceExceptionHandler#handleRemoteAPIException(RemoteApiException)}
   */
  @Test
  ...
  /**
   * Method under test:
   * {@link WebResourceExceptionHandler#handleUnauthorizedException(UnauthorizedUserException)}
   */
  @Test
  ...
  /**
   * Method under test:
   * {@link WebResourceExceptionHandler#handleForbiddenException(AuthenticationException)}
   */
  @Test
  ...
  /**
   * Method under test:
   * {@link WebResourceExceptionHandler#handleMissingRequiredParameterException(MissingRequiredParameterException)}
   */
  @Test
