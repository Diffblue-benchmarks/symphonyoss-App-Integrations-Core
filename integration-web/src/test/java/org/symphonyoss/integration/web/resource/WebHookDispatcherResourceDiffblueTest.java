...
public class WebHookDispatcherResourceDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link WebHookDispatcherResource#handleRemoteApiException(RemoteApiException)}
   */
  @Test
  @MethodsUnderTest({"ResponseEntity WebHookDispatcherResource.handleRemoteApiException(RemoteApiException)"})
