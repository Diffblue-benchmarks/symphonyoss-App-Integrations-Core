...
public class WebHookOriginCheckFilterDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link WebHookOriginCheckFilter#doFilter(ServletRequest, ServletResponse, FilterChain)}
   */
  @Test
  @MethodsUnderTest({"void WebHookOriginCheckFilter.doFilter(ServletRequest, ServletResponse, FilterChain)"})
  ...
  public void testDoFilter_thenThrowFactoryBeanNotInitializedException() throws IOException, ServletException {
    ...
    Response servletResponse = new Response();
    FilterChain filterChain = mock(FilterChain.class);
    doThrow(new FactoryBeanNotInitializedException(WebHookOriginCheckFilter.URL_PATTERN)).when(filterChain)
