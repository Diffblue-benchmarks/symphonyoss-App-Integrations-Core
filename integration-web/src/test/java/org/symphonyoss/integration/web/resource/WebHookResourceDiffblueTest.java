...
public class WebHookResourceDiffblueTest {
   ...
   * <ul>
   *   <li>Then throw {@link IntegrationUnavailableException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link WebHookResource#getWebHookIntegration(String)}
   */
  @Test
  @MethodsUnderTest({
   ...
   * </ul>
   * <p>
   * Method under test: {@link WebHookResource#checkIntegrationAvailability(String)}
   */
  @Test
  @MethodsUnderTest({
   ...
   * </ul>
   * <p>
   * Method under test: {@link WebHookResource#getConfigurationInstance(String, String, String)}
   */
  @Test
  @MethodsUnderTest({"IntegrationInstance WebHookResource.getConfigurationInstance(String, String, String)"})
  public void testGetConfigurationInstance_thenReturnIntegrationInstance() {
    ...
    when(integrationService.getInstanceById(Mockito.<String>any(), Mockito.<String>any(), Mockito.<String>any()))
        .thenReturn(integrationInstance);

    // Act
    IntegrationInstance actualConfigurationInstance = webHookDispatcherResource.getConfigurationInstance("42", "42",
        "Configuration Type");

    // Assert
    verify(integrationService).getInstanceById(Mockito.<String>any(), Mockito.<String>any(), Mockito.<String>any());
   ...
   *   <li>Then return Parameters size is one.</li>
   * </ul>
   * <p>
   * Method under test: {@link WebHookResource#retrieveWebHookPayload(HttpServletRequest, String)}
   */
  @Test
  @MethodsUnderTest({"WebHookPayload WebHookResource.retrieveWebHookPayload(HttpServletRequest, String)"})
   ...
   *   <li>Then return Body is {@code foo}.</li>
   * </ul>
   * <p>
  ...
  public void testHandleBadRequest_whenExceptionWithFoo_thenReturnBodyIsFoo() {
    // Arrange
    WebHookDispatcherResource webHookDispatcherResource = new WebHookDispatcherResource();
  ...
  public void testHandleNotFound_whenExceptionWithFoo_thenReturnBodyIsNull() {
    // Arrange
    WebHookDispatcherResource webHookDispatcherResource = new WebHookDispatcherResource();
   ...
   * </ul>
   * <p>
   * Method under test: {@link WebHookResource#handleConnectivityException(ConnectivityException)}
   */
  @Test
  @MethodsUnderTest({"ResponseEntity WebHookResource.handleConnectivityException(ConnectivityException)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link WebHookResource#handleServiceUnavailableException(Exception)}
   */
  @Test
  @MethodsUnderTest({"ResponseEntity WebHookResource.handleServiceUnavailableException(Exception)"})
  public void testHandleServiceUnavailableException_whenExceptionWithFoo_thenReturnBodyIsFoo() {
    // Arrange
    WebHookDispatcherResource webHookDispatcherResource = new WebHookDispatcherResource();
  ...
  /**
   * Test {@link WebHookResource#handleWebHookUnprocessableEntityException(WebHookUnprocessableEntityException)}.
   * <p>
   * Method under test: {@link WebHookResource#handleWebHookUnprocessableEntityException(WebHookUnprocessableEntityException)}
   */
  @Test
  @MethodsUnderTest({
   ...
   * <ul>
   *   <li>Then return Body is {@code Unexpected exception}.</li>
   * </ul>
   * <p>
   * Method under test: {@link WebHookResource#handleUnexpectedException(Exception)}
   */
  @Test
  @MethodsUnderTest({"ResponseEntity WebHookResource.handleUnexpectedException(Exception)"})
  public void testHandleUnexpectedException_thenReturnBodyIsUnexpectedException() {
    // Arrange
    WebHookDispatcherResource webHookDispatcherResource = new WebHookDispatcherResource();
