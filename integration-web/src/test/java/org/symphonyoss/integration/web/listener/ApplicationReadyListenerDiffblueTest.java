...
public class ApplicationReadyListenerDiffblueTest {
  /**
   * Test {@link ApplicationReadyListener#onApplicationEvent(ApplicationReadyEvent)} with {@code ApplicationReadyEvent}.
   * <ul>
   *   <li>Given {@link IntegrationLogging} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link ApplicationReadyListener#onApplicationEvent(ApplicationReadyEvent)}
   */
  @Test
  @MethodsUnderTest({"void ApplicationReadyListener.onApplicationEvent(ApplicationReadyEvent)"})
  public void testOnApplicationEventWithApplicationReadyEvent_givenIntegrationLogging() throws BeansException {
    // Arrange
   ...
   * Test {@link ApplicationReadyListener#onApplicationEvent(ApplicationReadyEvent)} with {@code ApplicationReadyEvent}.
   * <ul>
   *   <li>Then calls {@link IntegrationLogging#ready()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ApplicationReadyListener#onApplicationEvent(ApplicationReadyEvent)}
   */
  @Test
  @MethodsUnderTest({"void ApplicationReadyListener.onApplicationEvent(ApplicationReadyEvent)"})
  public void testOnApplicationEventWithApplicationReadyEvent_thenCallsReady() throws BeansException {
    // Arrange
    ApplicationReadyListener applicationReadyListener = new ApplicationReadyListener();
